...
ANPC_Employee_C__pf3765379532::ANPC_Employee_C__pf3765379532(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	auto& __Local__2 = (*(AccessPrivateProperty<FVector >((bpv__PaperSprite__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__2 = FVector(0.200000, 0.200000, 0.200000);
...
void ANPC_Employee_C__pf3765379532::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ANPC_Employee_C__pf3765379532::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void ANPC_Employee_C__pf3765379532::bpf__RandomPosition__pf(/*out*/ TArray<FTransform>& bpp__Transform__pf)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ANPC_Employee_C__pf3765379532::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ANPC_Employee_C__pf3765379532::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ANPC_Employee_C__pf3765379532
{
	FRegisterHelper__ANPC_Employee_C__pf3765379532()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Blueprints/NPC/Employee/NPC_Employee"), &ANPC_Employee_C__pf3765379532::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ANPC_Employee_C__pf3765379532 Instance;
};
FRegisterHelper__ANPC_Employee_C__pf3765379532 FRegisterHelper__ANPC_Employee_C__pf3765379532::Instance;
