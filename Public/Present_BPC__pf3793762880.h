...
#include "Present_BPC__pf3793762880.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Blueprints/BuildingDoorBP/Present_BPC.Present_BPC_C", OverrideNativeName="Present_BPC_C"))
class APresent_BPC_C__pf3793762880 : public AInteractionBox_BP_C__pf2132744816
{
public:
	GENERATED_BODY()
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, meta=(DisplayName="Can Do 0", Category="Default", MultiLine="true", OverrideNativeName="CanDo_0"))
	bool bpv__CanDo_0__pf;
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, meta=(DisplayName="New Var 0 0", Category="Default", MultiLine="true", OverrideNativeName="NewVar_0_0"))
	bool bpv__NewVar_0_0__pf;
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, meta=(DisplayName="Is UIOpened", Category="Default", MultiLine="true", OverrideNativeName="IsUIOpened"))
	bool bpv__IsUIOpened__pf;
	...
	APresent_BPC_C__pf3793762880(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_Present_BPC__pf_0(int32 bpp__EntryPoint__pf);
	UFUNCTION(meta=(OverrideNativeName="ExecuteUbergraph_Present_BPC_1"))
	void bpf__ExecuteUbergraph_Present_BPC__pf_1(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Present_BPC__pf_2(int32 bpp__EntryPoint__pf);
