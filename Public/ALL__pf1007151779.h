...
class UImage;
class UButton;
#include "ALL__pf1007151779.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/UI/menu/ALL.ALL_C", OverrideNativeName="ALL_C"))
class UALL_C__pf1007151779 : public UUserWidget
{
public:
	GENERATED_BODY()
	...
	UALL_C__pf1007151779(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
