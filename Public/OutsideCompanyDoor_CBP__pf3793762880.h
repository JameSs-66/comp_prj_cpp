...
#include "OutsideCompanyDoor_CBP__pf3793762880.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Blueprints/BuildingDoorBP/OutsideCompanyDoor_CBP.OutsideCompanyDoor_CBP_C,/Game/Blueprints/BuildingDoorBP/CompanyDoor_CBP.CompanyDoor_CBP_C,/Game/Blueprints/BuildingDoorBP/BuildingDoor_CBP.BuildingDoor_CBP_C", OverrideNativeName="OutsideCompanyDoor_CBP_C"))
class AOutsideCompanyDoor_CBP_C__pf3793762880 : public AInteractionBox_BP_C__pf2132744816
{
public:
	GENERATED_BODY()
	...
	AOutsideCompanyDoor_CBP_C__pf3793762880(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_OutsideCompanyDoor_CBP__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_OutsideCompanyDoor_CBP__pf_1(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_OutsideCompanyDoor_CBP__pf_2(int32 bpp__EntryPoint__pf);
