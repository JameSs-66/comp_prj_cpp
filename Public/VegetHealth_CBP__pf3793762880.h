...
class UUserWidget;
#include "VegetHealth_CBP__pf3793762880.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Blueprints/BuildingDoorBP/VegetHealth_CBP.VeGetHealth_CBP_C,/Game/Blueprints/BuildingDoorBP/ShopOpenUiDoor_CBP.ShopOpenUiDoor_CBP_C", OverrideNativeName="VeGetHealth_CBP_C"))
class AVeGetHealth_CBP_C__pf3793762880 : public AInteractionBox_BP_C__pf2132744816
{
public:
	GENERATED_BODY()
	...
	AVeGetHealth_CBP_C__pf3793762880(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_VeGetHealth_CBP__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_VeGetHealth_CBP__pf_1(int32 bpp__EntryPoint__pf);
