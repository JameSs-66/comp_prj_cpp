...
class UPaperSprite;
#include "NPC_ShopHS_Child__pf3765379532.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Blueprints/NPC/Employee/NPC_ShopHS_Child.NPC_ShopHS_Child_C,/Game/Blueprints/NPC/Employee/NPC_ShopE_Child.NPC_ShopE_Child_C", OverrideNativeName="NPC_ShopHS_Child_C"))
class ANPC_ShopHS_Child_C__pf3765379532 : public ANPC_ShopE_C__pf3765379532
{
public:
	GENERATED_BODY()
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, meta=(DisplayName="NPC2Sprite", Category="Default", MultiLine="true", OverrideNativeName="NPC2Sprite"))
	TArray<UPaperSprite*> bpv__NPC2Sprite__pf;
	...
	ANPC_ShopHS_Child_C__pf3765379532(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_NPC_ShopHS_Child__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_NPC_ShopHS_Child__pf_1(int32 bpp__EntryPoint__pf);
